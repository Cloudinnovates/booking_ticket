      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('admin');?>"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li>
          <a href="#">
            <i class="fa fa-th"></i> <span>Data Pemesanan</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin/rute'); ?>"><i class="fa fa-circle-o"></i> Daftar Rute</a></li>
            <li><a href="<?php echo base_url('admin/tambahrute'); ?>"><i class="fa fa-circle-o"></i> Tambah Rute</a></li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/adminLTE/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/adminLTE/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>assets/adminLTE/dist/img/user2-160x160.jpg" alt="user image" class="offline">
